...
Apesar de parecer simples, porém, quando a lista contém muitos números, Cérebro se confunde 
e acaba errando alguns cálculos.
...
{
    public class MultiplosDe2_3_4_5
    {
        public static void Executar()
        {
            Console.Write("Digite a quantidade números que há na lista: ");
            int suavariavel = int.Parse(Console.ReadLine());
            Console.Write("Digite os números da lista separados por um espaço em branco: ");
